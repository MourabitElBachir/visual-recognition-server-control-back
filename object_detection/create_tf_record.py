...
def main(_):
  ...
  label_map_dict = label_map_util.get_label_map_dict(get_correct_path('annotations/label_map.pbtxt'))

  logging.info('Reading from Pet dataset.')
  image_dir = get_correct_path('images')
  annotations_dir = get_correct_path('annotations')
