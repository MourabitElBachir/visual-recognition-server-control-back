...
flags.DEFINE_string('input_type', 'image_tensor', 'Type of input node. Can be '
                    ...
                    '`tf_example`]')
flags.DEFINE_string('pipeline_config_path', get_correct_path('ssd_mobilenet_v1_coco.config'),
                    'Path to a pipeline_pb2.TrainEvalPipelineConfig config '
                    'file.')
flags.DEFINE_string('trained_checkpoint_prefix', os.path.join(get_correct_path('models_training'), 'train',
                                                              'model.ckpt-3043'),
                    'Path to trained checkpoint, typically of the form '
                    'path/to/model.ckpt')
flags.DEFINE_string('output_directory', os.path.join(get_correct_path('models_training'), 'output_inference_graph'),
